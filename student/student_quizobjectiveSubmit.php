...
$query="SELECT * FROM quiz_objective where workload_id='$_POST[workload_id]' and status='1' order by id ASC";
...
$check_duplicate="SELECT * from mark_objective where student_id='$_SESSION[userID]' and workload_id='$_POST[workload_id]' ";
...
if(mysqli_num_rows($result_checkduplicate)==0){ //means student first do the quiz
	$sql="INSERT INTO mark_objective (student_id, workload_id, mark,submitted_on) 
VALUES ('$_SESSION[userID]', '$_POST[workload_id]', '$mark' , CURRENT_TIMESTAMP)";
	...
	$sql="UPDATE mark_objective SET mark='$mark',submitted_on=CURRENT_TIMESTAMP WHERE student_id='$_SESSION[userID]' and workload_id='$_POST[workload_id]' ";
}
