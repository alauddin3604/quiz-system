...
<div id="mySidenav" class="sidenav">
	<a href="student_subjectView.php" id="orderlist" ><i class="fa fa-list-ul" aria-hidden="true"></i> Register subject</a>
	<a href="student_registeredsubjectView.php" id="menusetting" ><i class="fa fa-cogs" aria-hidden="true"></i> Subject List</a>
